...
const phoneRules = {
  hu: {
    ...
    errorText: "Magyar számhoz 8-9 számjegy kell, pl: 30 123 4567",
  },
  us: {
    localPlaceholder: "201 555 5555",
    localRegex: /^\d{10}$/,
    errorText: "US számhoz 10 számjegy kell, pl: 201 555 5555",
  },
  gb: {
    localPlaceholder: "7700 900123",
    localRegex: /^\d{10}$/,
    errorText: "UK számhoz 10 számjegy kell, pl: 7700 900123",
  },
  ro: {
    localPlaceholder: "712 345 678",
    localRegex: /^\d{9}$/,
    errorText: "Román számhoz 9 számjegy kell, pl: 712 345 678",
  },
  de: {
    localPlaceholder: "1512 3456789",
    localRegex: /^\d{10,11}$/,
    errorText: "Német számhoz 10-11 számjegy kell, pl: 1512 3456789",
  },
  at: {
    localPlaceholder: "664 1234567",
    localRegex: /^\d{9,11}$/,
    errorText: "Osztrák számhoz 9-11 számjegy kell, pl: 664 1234567",
  },
  hr: {
    localPlaceholder: "91 123 4567",
    localRegex: /^\d{8,9}$/,
    errorText: "Horvát számhoz 8-9 számjegy kell, pl: 91 123 4567",
  },
  rs: {
    localPlaceholder: "60 1234567",
    localRegex: /^\d{8,9}$/,
    errorText: "Szerb számhoz 8-9 számjegy kell, pl: 60 1234567",
  },
};
...
const defaultRule = {
  ...
  localRegex: /^\d{6,12}$/,
  errorText: "A telefonszám formátuma hibás.",
};
